...
# Alternative 7z.exe, which does not need .dll file and comes from the source.
# wget https://raw.githubusercontent.com/ip7z/a/main/7z1900-x64.exe -O $DIR_NAME/7z.exe
