...
:: Download and integrate all post-SP1 updates up to February 2021
...
if "%IncludeNET4%"=="0" goto skipNET4setup
 ...
 copy /b /y "%~dp0hotfixes\ndp48-kb4600944-%ImageArchitecture%.exe" "%~dp0DVD\Updates" >nul 2>&1
 ...
 echo start /w "" "%%CDROM%%\Updates\ndp48-kb4600944-%ImageArchitecture%.exe" /q /norestart>>"%~dp0DVD\sources\$oem$\$$\Setup\Scripts\SetupComplete.cmd"
 echo reg delete "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\msiexec.exe" /f ^>nul 2^>^&^1>>"%~dp0DVD\sources\$oem$\$$\Setup\Scripts\SetupComplete.cmd"
 if "%ImageArchitecture%"=="x86" (
...
ECHO.
ECHO ================================================================
ECHO Adding package KB4601347 - February 2021 Cumulative...
ECHO ================================================================
ECHO.
"%~dp0tools\%HostArchitecture%\DISM\dism.exe" /Add-Package /Image:"%~dp0mount\%%i" /PackagePath:"%~dp0hotfixes\windows6.1-kb4601347-%ImageArchitecture%.msu"
