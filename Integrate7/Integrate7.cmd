...
:: Download and integrate all post-SP1 updates up to December 2019
...
if "%IncludeNET4%"=="0" goto skipNET4setup
 ...
 copy /b /y "%~dp0hotfixes\ndp48-kb4532941-%ImageArchitecture%.exe" "%~dp0DVD\Updates" >nul 2>&1
 ...
 echo start /w "" "%%CDROM%%\Updates\ndp48-kb4532941-%ImageArchitecture%.exe" /q /norestart>>"%~dp0DVD\sources\$oem$\$$\Setup\Scripts\SetupComplete.cmd"
...
ECHO.
ECHO ================================================================
ECHO Adding package KB4536952 - Servicing Stack 01/2020...
ECHO ================================================================
ECHO.
"%~dp0tools\%HostArchitecture%\DISM\dism.exe" /Add-Package /Image:"%~dp0mount\%%i" /PackagePath:"%~dp0hotfixes\Windows6.1-kb4536952-%ImageArchitecture%.msu"
...
ECHO.
ECHO ================================================================
ECHO Adding package KB2729094 - API update...
ECHO ================================================================
ECHO.
...
ECHO.
ECHO ================================================================
ECHO Adding package KB2533623 - Segoe UI symbol font...
ECHO ================================================================
ECHO.
...
ECHO.
ECHO ================================================================
ECHO Adding .NET 3.5.1 Cumulative packages...
ECHO ================================================================
ECHO.
...
ECHO.
ECHO ================================================================
ECHO Adding package KB4534310 - January 2020 Cumulative...
ECHO ================================================================
ECHO.
"%~dp0tools\%HostArchitecture%\DISM\dism.exe" /Add-Package /Image:"%~dp0mount\%%i" /PackagePath:"%~dp0hotfixes\windows6.1-kb4534310-%ImageArchitecture%.msu"

ECHO.
ECHO.
ECHO ================================================================
ECHO Adding package KB4539602 - Wallpaper bug fix...
ECHO ================================================================
ECHO.
"%~dp0tools\%HostArchitecture%\DISM\dism.exe" /Add-Package /Image:"%~dp0mount\%%i" /PackagePath:"%~dp0hotfixes\windows6.1-kb4539602-%ImageArchitecture%.msu"
...
for /L %%i in (%ImageStart%, 1, %ImageCount%) do (
 ...
 REM Disable telemetry Logs
 reg add "HKLM\TK_SYSTEM\ControlSet001\Control\WMI\AutoLogger\AutoLogger-Diagtrack-Listener" /v "Start" /t REG_DWORD /d 0 /f >nul
 reg add "HKLM\TK_SYSTEM\ControlSet001\Control\WMI\AutoLogger\SQMLogger" /v "Start" /t REG_DWORD /d 0 /f >nul
 reg add "HKLM\TK_SYSTEM\ControlSet002\Control\WMI\AutoLogger\AutoLogger-Diagtrack-Listener" /v "Start" /t REG_DWORD /d 0 /f >nul
 reg add "HKLM\TK_SYSTEM\ControlSet002\Control\WMI\AutoLogger\SQMLogger" /v "Start" /t REG_DWORD /d 0 /f >nul
 ...
 reg add "HKLM\TK_SOFTWARE\Microsoft\Internet Explorer\SearchScopes" /v "ShowSearchSuggestionsInAddressGlobal" /t REG_DWORD /d 1 /f >nul
 ...
 reg add "HKLM\TK_SOFTWARE\Microsoft\Internet Explorer\SearchScopes\{0BBF48E6-FF9D-4FAA-AA4D-BDBB423B2BE1}" /v "ShowSearchSuggestions" /t REG_DWORD /d 1 /f >nul
